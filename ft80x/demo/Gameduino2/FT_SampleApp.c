...
extern ft_const_uint8_t         Lena_Bitmap_RawData[] PROGMEM;
#endif

#ifdef FT_APP_ENABLE_APIS_SET2
extern ft_const_uint8_t Lenaface40[]  PROGMEM;
extern ft_const_uint8_t Mandrill256[] PROGMEM;
#endif

#ifdef FT_APP_ENABLE_APIS_SET3
extern ft_const_uint8_t Roboto_BoldCondensed_12[] PROGMEM;
#endif
...
ft_void_t FT_APP_Screen_P(ft_const_char8_t *str)
{
...
ft_const_uint8_t FT_APP_Snd_Array[5*58] =
...
ft_const_uint8_t FT_APP_Snd_TagArray[58] = {
	...
	while(LoopFlag--)
	{
		...
		for(ft_uint8_t i=0; i<numbtnrow; ++i)
		{
			for(ft_uint8_t j=0; j<numbtncol; ++j)
			{
				...
				FT_GPU_CoCmd_Text_P(phost, (wbutton/2) + j*wbutton,(hbutton/2) + hbutton*i, 26, OPT_CENTER, (ft_const_char8_t*)&FT_APP_Snd_Array[((i * numbtncol) + j)*5]);
			}
		}
