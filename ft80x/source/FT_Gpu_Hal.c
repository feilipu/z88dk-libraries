...
ft_const_int16_t FT_DispWidth = 480;
ft_const_int16_t FT_DispHeight = 272;
ft_const_int16_t FT_DispHCycle =  548;
ft_const_int16_t FT_DispHOffset = 43;
ft_const_int16_t FT_DispHSync0 = 0;
ft_const_int16_t FT_DispHSync1 = 41;
ft_const_int16_t FT_DispVCycle = 292;
ft_const_int16_t FT_DispVOffset = 12;
ft_const_int16_t FT_DispVSync0 = 0;
ft_const_int16_t FT_DispVSync1 = 10;
ft_const_uint8_t FT_DispPCLK = 5;
//ft_const_uint8_t FT_DispSwizzle = 3;    // xxx Swizzle for Gameduino2
ft_const_uint8_t FT_DispSwizzle = 0;    // xxx Swizzle 4DSystems FT843
ft_const_uint8_t FT_DispPCLKPol = 1;
