...
ft_void_t    FT_API_Write_CoCmd(ft_const_uint32_t cmd); // write a co-processor command

ft_void_t    FT_API_Write_DLCmd(ft_const_uint32_t cmd); // write a Download List (DL) command

ft_void_t    FT_API_Reset_DLBuffer(ft_void_t); // reset (0) the Download List (DL) command offset
