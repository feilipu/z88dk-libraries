...
ft_void_t GPU_CoCmd_SendCmd(GPU_HAL_Context_t *phost, ft_const_uint32_t cmd);
...
ft_void_t GPU_CoCmd_Text(GPU_HAL_Context_t *phost, ft_int16_t x, ft_int16_t y, ft_int16_t font, ft_uint16_t options, const ft_char8_t* s)
{
  ...
  GPU_CoCmd_SendCmd(phost, CMD_TEXT);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|(x&0xffff)));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)options<<16)|(font&0xffff)));
...
ft_void_t GPU_CoCmd_Number(GPU_HAL_Context_t *phost, ft_int16_t x, ft_int16_t y, ft_int16_t font, ft_uint16_t options, ft_int32_t n)
{
  ...
  GPU_CoCmd_SendCmd(phost, CMD_NUMBER);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)options<<16)|font));
  GPU_CoCmd_SendCmd(phost, n);
...
ft_void_t GPU_CoCmd_LoadIdentity(GPU_HAL_Context_t *phost)
{
  ...
  GPU_CoCmd_SendCmd(phost, CMD_LOADIDENTITY);
...
ft_void_t GPU_CoCmd_Toggle(GPU_HAL_Context_t *phost, ft_int16_t x, ft_int16_t y, ft_int16_t w, ft_int16_t font, ft_uint16_t options, ft_uint16_t state, const ft_char8_t* s)
{
  ...
  GPU_CoCmd_SendCmd(phost, CMD_TOGGLE);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)font<<16)|w));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)state<<16)|options));
  GPU_CoCmd_SendStr(phost, s);
...
ft_void_t GPU_CoCmd_Gauge(GPU_HAL_Context_t *phost, ft_int16_t x, ft_int16_t y, ft_int16_t r, ft_uint16_t options, ft_uint16_t major, ft_uint16_t minor, ft_uint16_t val, ft_uint16_t range)
{
  ...
  GPU_CoCmd_SendCmd(phost, CMD_GAUGE);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)options<<16)|r));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)minor<<16)|major));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)range<<16)|val));
...
ft_void_t GPU_CoCmd_RegRead(GPU_HAL_Context_t *phost, ft_uint32_t ptr, ft_uint32_t result) // fixme there's no result returned...?
{
  ...
  GPU_CoCmd_SendCmd(phost, CMD_REGREAD);
  GPU_CoCmd_SendCmd(phost, ptr);
  GPU_CoCmd_SendCmd(phost, 0);
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*4);
  GPU_CoCmd_SendCmd(phost, CMD_GETPROPS);
  GPU_CoCmd_SendCmd(phost, ptr);
  GPU_CoCmd_SendCmd(phost, w);
  GPU_CoCmd_SendCmd(phost, h);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*4));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*4);
  GPU_CoCmd_SendCmd(phost, CMD_MEMCPY);
  GPU_CoCmd_SendCmd(phost, dest);
  GPU_CoCmd_SendCmd(phost, src);
  GPU_CoCmd_SendCmd(phost, num);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*4));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*3);
  GPU_CoCmd_SendCmd(phost, CMD_SPINNER);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)scale<<16)|style));
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*3));
}
...
ft_void_t GPU_CoCmd_BgColor(GPU_HAL_Context_t *phost, ft_uint32_t c)
{
  ...
  GPU_CoCmd_SendCmd(phost, CMD_BGCOLOR);
  GPU_CoCmd_SendCmd(phost, c);
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*1);
  GPU_CoCmd_SendCmd(phost, CMD_SWAP);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*1));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*2);
  GPU_CoCmd_SendCmd(phost, CMD_INFLATE);
  GPU_CoCmd_SendCmd(phost, ptr);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*2));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*3);
  GPU_CoCmd_SendCmd(phost, CMD_TRANSLATE);
  GPU_CoCmd_SendCmd(phost, tx);
  GPU_CoCmd_SendCmd(phost, ty);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*3));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*1);
  GPU_CoCmd_SendCmd(phost, CMD_STOP);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*1));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*5);
  GPU_CoCmd_SendCmd(phost, CMD_SLIDER);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)h<<16)|w));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)val<<16)|options));
  GPU_CoCmd_SendCmd(phost, range);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*5));
}
...
ft_void_t GPU_CoCmd_TouchTransform(GPU_HAL_Context_t *phost, ft_int32_t x0, ft_int32_t y0, ft_int32_t x1, ft_int32_t y1, ft_int32_t x2, ft_int32_t y2, ft_int32_t tx0, ft_int32_t ty0, ft_int32_t tx1, ft_int32_t ty1, ft_int32_t tx2, ft_int32_t ty2, ft_uint16_t result)
{
  ...
  GPU_CoCmd_SendCmd(phost, CMD_TOUCH_TRANSFORM);
  GPU_CoCmd_SendCmd(phost, x0);
  GPU_CoCmd_SendCmd(phost, y0);
  GPU_CoCmd_SendCmd(phost, x1);
  GPU_CoCmd_SendCmd(phost, y1);
  GPU_CoCmd_SendCmd(phost, x2);
  GPU_CoCmd_SendCmd(phost, y2);
  GPU_CoCmd_SendCmd(phost, tx0);
  GPU_CoCmd_SendCmd(phost, ty0);
  GPU_CoCmd_SendCmd(phost, tx1);
  GPU_CoCmd_SendCmd(phost, ty1);
  GPU_CoCmd_SendCmd(phost, tx2);
  GPU_CoCmd_SendCmd(phost, ty2);
  GPU_CoCmd_SendCmd(phost, result);
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*2);
  GPU_CoCmd_SendCmd(phost, CMD_INTERRUPT);
  GPU_CoCmd_SendCmd(phost, ms);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*2));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*2);
  GPU_CoCmd_SendCmd(phost, CMD_FGCOLOR);
  GPU_CoCmd_SendCmd(phost, c);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*2));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*2);
  GPU_CoCmd_SendCmd(phost, CMD_ROTATE);
  GPU_CoCmd_SendCmd(phost, a);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*2));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*4 + (ft_uint16_t)strlen((ft_const_char8_t *)s) + 1);
  GPU_CoCmd_SendCmd(phost, CMD_BUTTON);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)h<<16)|w));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)options<<16)|font));
  GPU_CoCmd_SendStr(phost, s);
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*3);
  GPU_CoCmd_SendCmd(phost, CMD_MEMWRITE);
  GPU_CoCmd_SendCmd(phost, ptr);
  GPU_CoCmd_SendCmd(phost, num);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*3));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*5);
  GPU_CoCmd_SendCmd(phost, CMD_SCROLLBAR);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)h<<16)|w));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)val<<16)|options));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)range<<16)|size));
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*5));
}
...
ft_void_t GPU_CoCmd_GetMatrix(GPU_HAL_Context_t *phost, ft_int32_t a, ft_int32_t b, ft_int32_t c, ft_int32_t d, ft_int32_t e, ft_int32_t f)
{
  ...
  GPU_CoCmd_SendCmd(phost, CMD_GETMATRIX);
  GPU_CoCmd_SendCmd(phost, a);
  GPU_CoCmd_SendCmd(phost, b);
  GPU_CoCmd_SendCmd(phost, c);
  GPU_CoCmd_SendCmd(phost, d);
  GPU_CoCmd_SendCmd(phost, e);
  GPU_CoCmd_SendCmd(phost, f);
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*5);
  GPU_CoCmd_SendCmd(phost, CMD_SKETCH);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)h<<16)|w));
  GPU_CoCmd_SendCmd(phost, ptr);
  GPU_CoCmd_SendCmd(phost, format);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*5));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*4);
  GPU_CoCmd_SendCmd(phost, CMD_MEMSET);
  GPU_CoCmd_SendCmd(phost, ptr);
  GPU_CoCmd_SendCmd(phost, value);
  GPU_CoCmd_SendCmd(phost, num);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*4));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*2);
  GPU_CoCmd_SendCmd(phost, CMD_GRADCOLOR);
  GPU_CoCmd_SendCmd(phost, c);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*2));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*6*2+CMD_SIZE*2);
  GPU_CoCmd_SendCmd(phost, CMD_BITMAP_TRANSFORM);
  GPU_CoCmd_SendCmd(phost, x0);
  GPU_CoCmd_SendCmd(phost, y0);
  GPU_CoCmd_SendCmd(phost, x1);
  GPU_CoCmd_SendCmd(phost, y1);
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*2);
  GPU_CoCmd_SendCmd(phost, CMD_CALIBRATE);
  GPU_CoCmd_SendCmd(phost, result);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*2));
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*3);
  GPU_CoCmd_SendCmd(phost, CMD_SETFONT);
  GPU_CoCmd_SendCmd(phost, font);
  GPU_CoCmd_SendCmd(phost, ptr);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*3));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*1);
  GPU_CoCmd_SendCmd(phost, CMD_LOGO);
  GPU_CoCmd_EndFunc(phost,CMD_SIZE*1);
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*3);
  GPU_CoCmd_SendCmd(phost, CMD_APPEND);
  GPU_CoCmd_SendCmd(phost, ptr);
  GPU_CoCmd_SendCmd(phost, num);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*3));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*3);
  GPU_CoCmd_SendCmd(phost, CMD_MEMZERO);
  GPU_CoCmd_SendCmd(phost, ptr);
  GPU_CoCmd_SendCmd(phost, num);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*3));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*3);
  GPU_CoCmd_SendCmd(phost, CMD_SCALE);
  GPU_CoCmd_SendCmd(phost, sx);
  GPU_CoCmd_SendCmd(phost, sy);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*3));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*5);
  GPU_CoCmd_SendCmd(phost, CMD_CLOCK);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)options<<16)|r));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)m<<16)|h));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)ms<<16)|s));
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*5));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*5);
  GPU_CoCmd_SendCmd(phost, CMD_GRADIENT);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y0<<16)|x0));
  GPU_CoCmd_SendCmd(phost, rgb0);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y1<<16)|x1));
  GPU_CoCmd_SendCmd(phost, rgb1);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*5));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*1);
  GPU_CoCmd_SendCmd(phost, CMD_SETMATRIX);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*1));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*4);
  GPU_CoCmd_SendCmd(phost, CMD_TRACK);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)h<<16)|w));
  GPU_CoCmd_SendCmd(phost, tag);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*4));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*2);
  GPU_CoCmd_SendCmd(phost, CMD_GETPTR);
  GPU_CoCmd_SendCmd(phost, result);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*2));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*5);
  GPU_CoCmd_SendCmd(phost, CMD_PROGRESS);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)h<<16)|w));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)val<<16)|options));
  GPU_CoCmd_SendCmd(phost, range);
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*1);
  GPU_CoCmd_SendCmd(phost, CMD_COLDSTART);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*1));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*4 + (ft_uint16_t)strlen((ft_const_char8_t *)s) + 1);
  GPU_CoCmd_SendCmd(phost, CMD_KEYS);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)h<<16)|w));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)options<<16)|font));
  GPU_CoCmd_SendStr(phost, s);
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*4);
  GPU_CoCmd_SendCmd(phost, CMD_DIAL);
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  GPU_CoCmd_SendCmd(phost, (((ft_uint32_t)options<<16)|r));
  GPU_CoCmd_SendCmd(phost, val);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*4));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*3);
  GPU_CoCmd_SendCmd(phost, CMD_LOADIMAGE);
  GPU_CoCmd_SendCmd(phost, ptr);
  GPU_CoCmd_SendCmd(phost, options);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*3));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*1);
  GPU_CoCmd_SendCmd(phost, CMD_DLSTART);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*1));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*2);
  GPU_CoCmd_SendCmd(phost, CMD_SNAPSHOT);
  GPU_CoCmd_SendCmd(phost, ptr);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*2));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*1);
  GPU_CoCmd_SendCmd(phost, CMD_SCREENSAVER);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*1));
}
...
{
  GPU_CoCmd_StartFunc(phost,CMD_SIZE*4);
  GPU_CoCmd_SendCmd(phost, CMD_MEMCRC);
  GPU_CoCmd_SendCmd(phost, ptr);
  GPU_CoCmd_SendCmd(phost, num);
  GPU_CoCmd_SendCmd(phost, result);
  GPU_CoCmd_EndFunc(phost,(CMD_SIZE*4));
