...
ft_void_t GPU_CoCmd_RegRead(GPU_HAL_Context_t *phost, ft_uint32_t ptr, ft_uint32_t result); // fixme but there's no result returned..?
...
ft_void_t GPU_CoCmd_Bitmap_Transform(GPU_HAL_Context_t *phost, ft_int32_t x0, ft_int32_t y0, ft_int32_t x1, ft_int32_t y1, ft_int32_t x2, ft_int32_t y2, ft_int32_t tx0, ft_int32_t ty0, ft_int32_t tx1, ft_int32_t ty1, ft_int32_t tx2, ft_int32_t ty2, ft_uint16_t result);
