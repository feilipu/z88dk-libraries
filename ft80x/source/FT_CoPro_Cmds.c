...
ft_void_t FT_GPU_CoCmd_SendStr_P(FT_GPU_HAL_Context_t *phost, ft_const_char8_t *s) __attribute__ ( ( hot, flatten ) );
...
ft_void_t FT_GPU_CoCmd_SendStr_P(FT_GPU_HAL_Context_t *phost, ft_const_char8_t *s)
{
...
ft_void_t FT_GPU_CoCmd_Text_P(FT_GPU_HAL_Context_t *phost, ft_int16_t x, ft_int16_t y, ft_int16_t font, ft_uint16_t options, ft_const_char8_t* s)
{
  FT_GPU_CoCmd_StartFunc(phost,FT_CMD_SIZE*3 + (ft_uint16_t)strlen_P((ft_const_char8_t *)s) + 1);
  FT_GPU_Copro_SendCmd(phost, CMD_TEXT);
  FT_GPU_Copro_SendCmd(phost, (((ft_uint32_t)y<<16)|(x&0xffff)));
  FT_GPU_Copro_SendCmd(phost, (((ft_uint32_t)options<<16)|(font&0xffff)));
  FT_GPU_CoCmd_SendStr_P(phost, s);
  FT_GPU_CoCmd_EndFunc(phost,(FT_CMD_SIZE*3 + (ft_uint16_t)strlen_P((ft_const_char8_t *)s) + 1));
}
...
ft_void_t FT_GPU_CoCmd_Toggle_P(FT_GPU_HAL_Context_t *phost, ft_int16_t x, ft_int16_t y, ft_int16_t w, ft_int16_t font, ft_uint16_t options, ft_uint16_t state, ft_const_char8_t* s)
{
  FT_GPU_CoCmd_StartFunc(phost,FT_CMD_SIZE*4 + (ft_uint16_t)strlen_P((ft_const_char8_t *)s) + 1);
  FT_GPU_Copro_SendCmd(phost, CMD_TOGGLE);
  FT_GPU_Copro_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
  FT_GPU_Copro_SendCmd(phost, (((ft_uint32_t)font<<16)|w));
  FT_GPU_Copro_SendCmd(phost, (((ft_uint32_t)state<<16)|options));
  FT_GPU_CoCmd_SendStr_P(phost, s);
  FT_GPU_CoCmd_EndFunc(phost,(FT_CMD_SIZE*4 + (ft_uint16_t)strlen_P((ft_const_char8_t *)s) + 1));
}
...
ft_void_t FT_GPU_CoCmd_Button_P(FT_GPU_HAL_Context_t *phost, ft_int16_t x, ft_int16_t y, ft_int16_t w, ft_int16_t h, ft_int16_t font, ft_uint16_t options, ft_const_char8_t* s)
{
  FT_GPU_CoCmd_StartFunc(phost,FT_CMD_SIZE*4 + (ft_uint16_t)strlen_P((ft_const_char8_t *)s) + 1);
  FT_GPU_Copro_SendCmd(phost, CMD_BUTTON);
  FT_GPU_Copro_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
...
ft_void_t FT_GPU_CoCmd_Keys_P(FT_GPU_HAL_Context_t *phost, ft_int16_t x, ft_int16_t y, ft_int16_t w, ft_int16_t h, ft_int16_t font, ft_uint16_t options, ft_const_char8_t* s)
{
  FT_GPU_CoCmd_StartFunc(phost,FT_CMD_SIZE*4 + (ft_uint16_t)strlen_P((ft_const_char8_t *)s) + 1);
  FT_GPU_Copro_SendCmd(phost, CMD_KEYS);
  FT_GPU_Copro_SendCmd(phost, (((ft_uint32_t)y<<16)|x));
