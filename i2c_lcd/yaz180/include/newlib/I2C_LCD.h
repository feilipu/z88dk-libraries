...
__OPROTO(,,void,,LCD_CharGotoXY,uint8_t x, uint8_t y)

//  void LCD_DispCharAt(char character, uint8_t x, uint8_t y);
__OPROTO(,,void,,LCD_DispCharAt,char character, uint8_t x, uint8_t y)

//  void LCD_DispStringAt(char *buf, uint8_t x, uint8_t y);
__OPROTO(,,void,,LCD_DispStringAt,char *buf, uint8_t x, uint8_t y)

//  void LCD_CursorConf(enum LCD_SwitchState swi, uint8_t freq);
__OPROTO(,,void,,LCD_CursorConf,enum LCD_SwitchState swi, uint8_t freq)
...
__OPROTO(,,void,,LCD_DrawHLineAt,uint8_t startX, uint8_t endX, uint8_t y, enum LCD_ColorSort color)

//  void LCD_DrawVLineAt(uint8_t startY, uint8_t endY, uint8_t x, enum LCD_ColorSort color);
__OPROTO(,,void,,LCD_DrawVLineAt,uint8_t startY, uint8_t endY, uint8_t x, enum LCD_ColorSort color)

//  void LCD_DrawLineAt(uint8_t startX, uint8_t endX, uint8_t startY, uint8_t endY, enum LCD_ColorSort color);
__OPROTO(,,void,,LCD_DrawLineAt,uint8_t startX, uint8_t endX, uint8_t startY, uint8_t endY, enum LCD_ColorSort color)

//  void LCD_DrawRectangleAt(uint8_t x, uint8_t y, uint8_t width, uint8_t height, enum LCD_DrawMode mode);
__OPROTO(,,void,,LCD_DrawRectangleAt,uint8_t x, uint8_t y, uint8_t width, uint8_t height, enum LCD_DrawMode mode)

//  void LCD_DrawCircleAt(uint8_t x, uint8_t y, uint8_t r, enum LCD_DrawMode mode);
__OPROTO(,,void,,LCD_DrawCircleAt,uint8_t x, uint8_t y, uint8_t r, enum LCD_DrawMode mode)
...
__OPROTO(,,void,,LCD_ReadByteDispRAM,uint8_t x, uint8_t y)

//  void LCD_WriteByteDispRAM(uint8_t byte, uint8_t x, uint8_t y);
__OPROTO(,,void,,LCD_WriteByteDispRAM,uint8_t byte, uint8_t x, uint8_t y)

//  void LCD_ReadSeriesDispRAM(uint8_t *buf, uint8_t length, uint8_t x, uint8_t y);
__OPROTO(,,void,,LCD_ReadSeriesDispRAM,uint8_t *buf, uint8_t length, uint8_t x, uint8_t y)

//  void LCD_WriteSeriesDispRAM(uint8_t *buf, uint8_t length, uint8_t x, uint8_t y);
__OPROTO(,,void,,LCD_WriteSeriesDispRAM,uint8_t *buf, uint8_t length, uint8_t x, uint8_t y)

//  void LCD_DisplayConf(enum LCD_DisplayMode mode);
__OPROTO(,,void,,LCD_DisplayConf,enum LCD_DisplayMode mode)

//  void LCD_WorkingModeConf(enum LCD_SwitchState logoSwi, enum LCD_SwitchState backLightSwi, enum LCD_WorkingMode mode);
__OPROTO(,,void,,LCD_WorkingModeConf,enum LCD_SwitchState logoSwi, enum LCD_SwitchState backLightSwi, enum LCD_WorkingMode mode)

//  void LCD_BacklightConf(enum LCD_SettingMode mode, uint8_t byte);
__OPROTO(,,void,,LCD_BacklightConf,enum LCD_SettingMode mode, uint8_t byte)

//  void LCD_ContrastConf(enum LCD_SettingMode mode, uint8_t byte);
__OPROTO(,,void,,LCD_ContrastConf,enum LCD_SettingMode mode, uint8_t byte)

//  void LCD_DeviceAddrEdit(uint8_t newAddr);
__OPROTO(,,void,,LCD_DeviceAddrEdit,uint8_t newAddr)
