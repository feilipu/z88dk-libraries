...
__OPROTO(,,void,,LCD_ReadSeriesDispRAM,uint8_t *buf, uint16_t length, uint8_t x, uint8_t y)

//  void LCD_WriteSeriesDispRAM(uint8_t *buf, uint16_t length, uint8_t x, uint8_t y);
__OPROTO(,,void,,LCD_WriteSeriesDispRAM,uint8_t *buf, uint16_t length, uint8_t x, uint8_t y)
