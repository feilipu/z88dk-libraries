...
// zcc +yaz180 -subtype=app -clib=sdcc_iy -SO3 -v -m --list -pragma-define:CRT_ITERM_TERMINAL_FLAGS=0x0190 -pragma-define:TTY_ITERM_TERMINAL_FLAGS=0x0190 --max-allocs-per-node400000 -llib/yaz180/freertos TaskStatus.c -o TaskStatus -create-app
// cat > /dev/ttyUSB0 < TaskStatus.ihx

// zcc +scz180 -subtype=hbios -clib=sdcc_iy -SO3 -v -m --list -pragma-define:CRT_ITERM_TERMINAL_FLAGS=0x0190 -pragma-define:TTY_ITERM_TERMINAL_FLAGS=0x0190 --max-allocs-per-node400000 -llib/scz180/freertos TaskStatus.c -o TaskStatus -create-app
// cat > /dev/ttyUSB0 < TaskStatus.ihx
